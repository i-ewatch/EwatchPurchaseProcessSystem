...
namespace EwatchPurchase.Form.Test.FQ
{
    public partial class ReportFQ : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void Textchange(string projectno, string buyno, string projectpurchaseer, string branch, string project, string appdate, string buylimitdate, string needdate, string pickup, string deliery, bool devicecheck, bool materialcheck, bool constructioncheck, bool hangcheck, bool elsecheck, bool inagreement, bool noagreement, bool just, bool suggest, bool remark)
        {
